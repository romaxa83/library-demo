...
class TestUpdateBook:
    ...
    def test_update_book_success(self, client, create_book):
    ...
    def test_update_book_partial(self, client, create_book):
    ...
    def test_update_book_only_author(self, client, create_book, create_author):
    ...
    def test_update_book_only_author_not_exist(self, client, create_book):
    ...
    def test_update_book_only_author_deleted(self, client, create_book, create_author):
    ...
    def test_update_book_not_found(self, client):
        ...
        response = client.patch("/books/1", json=_update_data)
        assert response.status_code == status.HTTP_404_NOT_FOUND
        assert response.json()["detail"] == "Book with id 1 not found"

    def test_update_deleted_book(self, client, create_book):
